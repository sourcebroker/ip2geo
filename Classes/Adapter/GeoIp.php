...
class GeoIp extends AbstractAdapter
{
    ...
    protected function __construct($databaseName, $ip = null)
    {
        ...
        if (!file_exists($databasePath . $databaseName . '_' . \SourceBroker\Ip2geo\Utility\GeneralUtility::getHash($databaseName) . '.mmdb')) {
            throw new Exception('Database file does not exist');
        }

        $this->dbPath = $databasePath . $databaseName . '_' . \SourceBroker\Ip2geo\Utility\GeneralUtility::getHash($databaseName) . '.mmdb';
    }
